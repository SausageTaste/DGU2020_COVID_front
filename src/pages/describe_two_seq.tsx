...
export default class Describe_two_seq extends React.Component<desProps, desState> {
    ...
    public render() {
        ...
        const describe_txt = (
            <div style={describe_style}>
                <br/>
                <p>{i18n.t("describe_method_two_seq")}</p>
                <br/>
                <p>{i18n.t("describe_feature_of_function")}</p>
                <div style={describe_style}>
                    <p>{i18n.t("describe_feature_1_two_seq")}</p>
                    <p>{i18n.t("describe_feature_2_two_seq")}</p>
                </div>
            </div>);
